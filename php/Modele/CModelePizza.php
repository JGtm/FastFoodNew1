...
//        $pid = $this->DB->insert_id('id_pizza','Pizzas');
	...
	$this->DB->insert('Produits', 'id_produit, libelle_produit, prix_produit, description, image, id_type_produit, id_pizza', '"", "' . $this->libelle . '", "' . $this->prix . '", "' . $this->description . '", "' . $this->image . '", ' . $this->type_produit . ', ' . $pid[0]
	);
